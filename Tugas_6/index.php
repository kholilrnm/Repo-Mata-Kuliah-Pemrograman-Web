...
<head>
<meta charset="utf-8" />
<title>Tugas 6 Update + Delete database</title>
...
<div class="container_16">
  <h2>
    Tugas 6 Update + Delete database
  </h2>
<center>
<form>
  <button type="submit" formaction="table_from_db.php"> data_ku tabel DB</button>&nbsp;&nbsp;
  <button type="submit" formaction=" data_array_db.php"> data_ku Hasil Fetch Array</button>
</form>
</center><br>
  ...
  <table class="table-container">
    <tr>
      ...
      <td class="tentangku"><hr>
        <h2 class="title">Bio data_ku Diri</h2><br>
          <table class="bio data_ku">
            <tr>
...
<button type="submit" style="margin-left: 45.5%;">KIRIM  data_ku ANDA</button>
</form>
</div>
