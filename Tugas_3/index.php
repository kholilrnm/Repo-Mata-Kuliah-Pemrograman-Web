...
<head>
<meta charset="utf-8" />
<title>Tugas Basic PHP &mdash; Demo</title>
...
<div id='muncul'>
  <div class="body-tes">
<h1>
  <a href="http://960.gs/">Tugas Basic PHP - POST</a>
</h1>
...
<div class="grid_9">
   <div class="header-content">
      <div id="gayasatu"><p class="gayasatu" style="font-size: 16px"><b>Kholilul Rachman Nur Manab</b></p></div> 
      <hr class="gayadua" align="left" size="2px" color="#b5651d"> 
      <p class="gayatiga">Mahasiswa UPN "Veteran" Jawa Timur</p> 
      <p class="gayatiga">17081010055 | Fakultas Ilmu Komputer, Program Studi Teknik Informatika</p> 
        ...
        <h2 class="title">Biodata Diri</h2><br>
          <table class="biodata">
            <tr>
              ...
              <td class="text">
                &emsp; : &emsp;Kholilul Rachman N.M<br>
                &emsp; : &emsp;Surabaya, 5 April 1998<br>
                &emsp; : &emsp;Jl. Rungkut Lor X No 115-C, Surabaya<br>
                &emsp; : &emsp;Laki-Laki<br>
                &emsp; : &emsp;Belum Menikah<br>
                &emsp; : &emsp;Islam<br>
                &emsp; : &emsp;167 Cm / 60 Kg<br>
                &emsp; : &emsp;O-<br>
                &emsp; : &emsp;Indonesia<br>
                &emsp; : &emsp;085-731866606<br>
                &emsp; : &emsp;kholil.zboy@gmail.com<br>
                &emsp; : &emsp;Sekolah Menengah Atas<br>
                &emsp; : &emsp;Ngoding, Membaca Buku Islami<br>
                &emsp; : &emsp;kholilzboy.xyz (Maintenance)<br>
              </td>
            </tr>
          </table>
      </td>
        ...
        <h2 class="title">Pengalaman</h2>
          <table class="peng" border="2">
            ...
            <tr class="content-pengalaman">
              ...
              <td width="250px;">Tahfidzul Qur'an</td>
            ...
            <tr class="content-pengalaman">
              ...
              <td>Organisasi</td>
              <td>WIsSNU(Wahana Inspirasi Santri Nurul Ummah) </td> 
              <td>Ketua Infokom</td>
            </tr>
            ...
            <tr class="content-pengalaman">
              ...
              <td>Organisasi</td>
              <td>Himah UPN Veteran Jawa Timur</td>
