...
<head>
<meta charset="utf-8" />
<title>Tugas Basic PHP &mdash; Demo Kosong</title>
...
<div id='muncul'>
  <div class="body-tes">
<h1>
  <a href="http://960.gs/">Ini Halaman Hasil POST</a>
</h1>
          ...
          <table class="biodata">
            <tr>
              ...
              <td class="text">
                ...
                $date1=$_POST['19nama'];
                if (($date1>16)) {
                   echo "Saya sudah dewasa".$_POST['19nama'];
                 }
                else{
                  echo "saya belum dewasa".$_POST['19nama'];
                 }
            ?> --><br>
              </td>
            </tr>
